                    ...
                    <div class="row">
                                        ...
                                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                <thead>
                                                        <tr>
                                                            ...
                                                            <th class="text-center">File Sumbangan</th>
                                                    ...
                                                    foreach($data_mhs as $data) :  ?>
                                                        <tr>
                                                            ...
                                                            <?php if($data['file_sumbangan'] != '') {?>
                                                                <td class="text-center"> <a href="<?=base_url('file_mhs/file_sumbangan/'.$data['file_sumbangan']) ?>" target="_blank" class="btn btn-primary btn-sm "> 
                                                                        <i class="fa fa-fw fa-download"></i> <?=$data['file_sumbangan']; ?> </a>
                                                                </td>
                                                            ...
                                                            <?php if($data['file_sumbangan'] != '') { ?>
                                                                <td class="text-center"> 
                                                                        <form action="<?php echo base_url('Backend/Validasi_sum/lengkap_sum/'.$data['npm']); ?>" method="post"> 
                        ...
                        <?php foreach($data_mhs as $data) { ?> 
                            <div class="modal fade" id="edit_data<?= $data['npm'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Edit Data Sumbangan</h5>
                                        ...
                                        <div class="modal-body">
                                                <form action="<?= base_url('Backend/Validasi_sum/update_data_sum'); ?>" method="post" enctype="multipart/form-data">
                                                <?= csrf_field() ?>
                        ...
                        <?php foreach($data_mhs as $data) { ?> 
                            <div class="modal fade" id="block<?= $data['npm'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-body">
                                            <form action="<?= base_url('Backend/Validasi_sum/belum_lengkap_sum'); ?>" method="post" >
                                                <?= csrf_field(); ?>
                                                    <input type="hidden" name="npm" value="<?= $data['npm']; ?>">
                                                     <input type="hidden" name="fileLama" value="<?= $data['file_sumbangan']; ?>">
