                    ...
                    <div class="row">
                                        ...
                                        <table id="" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                <thead>
                                                        <tr>
                                                            ...
                                                            <th class="text-center">File Tugas Akhir</th>
                                                    ...
                                                    foreach($data_mhs as $data) :  ?>
                                                        <tr>
                                                            ...
                                                            <?php } else {?>
                                                                <td class="text-center"> Mahasiswa Belum Input Judul </td>
                                                            <?php } ?>

                                                            <?php if($data['file_TA'] != '') {?>
                                                                <td class="text-center"> <a href="<?=base_url('file_mhs/file_ta/'.$data['file_TA']) ?>" target="_blank" class="btn btn-primary btn-sm "> 
                                                                        <i class="fa fa-fw fa-download"></i> <?=$data['file_TA']; ?> </a>
                                                                </td>
                                                            
                                                            <?php } else {?>
                                                                <td class="text-center"> 
                                                                Mahasiswa Belum Input File                                                         
                                                                </td>
                                                            <?php } ?>
                                                            ...
                                                            <?php if($data['file_TA'] != '') { ?>
                                                                <td class="text-center"> 
                                                                        ...
                                                                        <form action="<?php echo base_url('Backend/Validasi/lengkap_ta/'.$data['npm']); ?>" method="post"> 
                        ...
                        <div class="modal fade" id="edit_data<?= $data['npm'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Edit data Tugas Akhir</h5>
                                    ...
                                    <div class="modal-body">
                                            <form action="<?= base_url('Backend/Validasi/update_data_ta'); ?>" method="post" enctype="multipart/form-data">
                                            <?= csrf_field() ?>
                        ...
                        <?php foreach($data_mhs as $data) { ?> 
                            <div class="modal fade" id="block<?= $data['npm'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-body">
                                            <form action="<?= base_url('Backend/Validasi/belum_lengkap_ta'); ?>" method="post" >
                                                <?= csrf_field(); ?>
                                                    <input type="hidden" name="npm" value="<?= $data['npm']; ?>">
                                                     <input type="hidden" name="fileLama" value="<?= $data['file_TA']; ?>">
